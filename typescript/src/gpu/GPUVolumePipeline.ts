...
import { GPUPrimitive } from "../data/Primitive.js";
...
export class VolumePipeline<
    Input extends Record<string, GPUPrimitive>,
    Output extends Record<string, GPUPrimitive>
> {
